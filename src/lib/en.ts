    ...
    approaches: [
      {
        ...
        description: "We nurture the whole learner—building not just exam skills, but confidence, curiosity, and a lifelong appreciation for the Chinese language.",
        icon: "/globe.svg"
      },
      {
        name: "Bilingual Proficiency",
        description: "Our approach bridges English and Chinese, helping students develop strong bilingual communication skills essential for Singapore's academic and professional landscape.",
        icon: "/globe.svg"
      },
      {
        name: "Small Class Size",
        description: "With a maximum of 6–8 students per class, every student receives focused attention, personalised feedback, and the space to learn at their own pace.",
        icon: "/globe.svg"
      },
      {
        name: "Interactive & Engaging Teaching",
        description: "Our lessons go beyond rote learning—through discussion, contextual activities, and structured practice, we make Chinese enjoyable and meaningful.",
        icon: "/globe.svg"
      }
    ],
