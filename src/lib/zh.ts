...
我们的目标不只是提高分数，更让学生具备自信表达、深入思考的能力，为学生的未来学习做好准备。`,
  ...
  testimonialsSection: {
    reviews: [
      {
        content: "我是在口试前一周才跟冉老师学习的，但她帮助了我很多，让我在短时间内进步很快。冉老师非常愿意帮助我们，考试之前安排了多次补习班。她也很耐心解释我的问题，给出详细的建议。她的教学材料内容丰富，覆盖了考试的重点，帮助我更高效地复习。每节课都非常充实，不仅提高了我的语言能力，还让我对学习中文更有信心。多亏了老师的帮助，我最终在IB考试中拿到了7分！我非常感谢她的细心指导和支持！",
        image: "/globe.svg",
        author: "IB 学生"
      },
      {
      ...
      {
        content: "谢谢你，你教孩⼦⽔平很⾼呀，他这次是考的最好的成绩了。你的⽅法应该很好，他才补了⼏个⽉，这成绩提⾼这么快。我们全家都很感激冉老师的用心教导。孩子现在对华文有了更多的兴趣和自信，这是最大的收获。",
        author: "家长"
      },
      {
        content: "冉老师的作文和理解教学方法非常系统化，帮助我掌握了更好的写作技巧。我特别喜欢她如何将复杂的主题分解成易于理解的部分，并为不同类型的文章提供清晰的框架。自从参加她的课程以来，我对华文的信心大大增强了。每次上课都收获满满。",
        image: "/globe.svg",
        author: "小学六年级学生"
      },
      {
        content: "冉老师不仅是一位优秀的华文教师，更是一位能够激发学生学习兴趣的良师益友。她的课堂氛围轻松活泼，让学生在愉快的环境中学习。她对每个学生的关注和鼓励，让孩子们更愿意开口说华语，更有动力去学习。感谢冉老师的付出！",
        author: "中学生"
      }
    ]
  },
