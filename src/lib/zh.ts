...
通过系统训练，帮助学生提升分析深度与表达准确度，应对 A Level 考试中的高阶要求。`,
  ...
  testimonialsSection: {
    reviews: [
      ...
      {
        content: "于老师上课非常生动，我的孩子特别喜欢她，五年级的华文成绩也进步了许多。特别感谢能遇到这么负责任的老师。"
      },
      {
        content: "我的孩子曾经特别不喜欢华文，直到他上了陈老师的华文课。陈老师风趣的教学风格和帮助提高了他在学校的成绩。多亏了陈老师的教导，他O水准华文考试取得了理想的成绩"
      },
      {
        content: "我很喜欢上全老师的课，非常期待上每个星期的华文课！"
      },
      {
        content: "陈老师是个非常负责任的老师，特别放心把孩子交给她辅导。在陈老师的帮助下，我的孩子的华文成绩提升了很多，她也更加愿意去学华文。真的非常感谢她！"
      }
    ]
  },
  blogSection: {
